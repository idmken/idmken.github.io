...
- [Everything you should know about certificates and PKI but are too afraid to ask By: Mike Malone via smallstep (15 min read)](https://smallstep.com/blog/everything-pki/){:target="_blank"}{:rel="noopener noreferrer"}  **If you work in identity you will come across certificates and PKI. Either issued to people or devices and they are a black hole of wonder and frustration.**
...
### Articles Related to Federation and Golden SAML
...
- [Golden SAML: Newly Discovered Attack Technique Forges Authentication to Cloud Apps By: CyberArk (15 min read)](https://www.cyberark.com/resources/threat-research-blog/golden-saml-newly-discovered-attack-technique-forges-authentication-to-cloud-apps){:target="_blank"}{:rel="noopener noreferrer"} ***Similar to Golden ticket attacks but specific to SAML key compromises.***
  ...
  - [OGC Testbed-16: Federated Security By: The Open Geospatial Consortium (32 min read)](https://docs.ogc.org/per/20-027.html){:target="_blank"}{:rel="noopener noreferrer"} **In-depth article on federation security, threat modeling, emerging models, and roadmap**
